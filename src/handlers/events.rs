...
//! High-throughput zero-copy and batch event ingestion endpoints.
//! Connects to: src/models/event.rs, src/services/ring_buffer.rs, src/handlers/mod.rs
//! Created: 2026-08-28
...
use crate::models::{
    BatchIngestRequest, BatchIngestResponse, EventIngestResponse, RecentEventsQuery,
    RecentEventsResponse, ZeroCopyEvent,
};
use crate::services::RingBufferService;

/// Handler for `POST /api/v1/events/ingest/zerocopy`.
/// Deserializes directly from raw bytes using string slice borrows.
///
/// # Arguments
